...
import com.chat.api.mappers.ChatMapper;
...
public class ChatService {
    ...
    public ChatResponseDto getOrCreateChat(Integer senderId, Integer receiverId) {
        ...
        if (senderId.equals(receiverId)) {
            ...
            existingChat = chatRepository.findByParticipantsContainingAndParticipantsContaining(sender.getId(),
                    receiver.getId());
        }
        ...
        Chat chat = existingChat.orElseGet(() -> {
            ...
            if (!senderId.equals(receiverId)) {
                ...
                chatUserReceive.setId(new ChatUserId(newChat.getId(), receiver.getId())); // Establecer la clave
                                                                                          // compuesta
    ...
    public List<ChatResponseDto> getChatsByAuthenticatedUser() {
        ...
        List<Chat> chats = user.getChats().stream()
                ...
                .peek(chatUser -> chatUser.getChat().setUnreadMessages(chatUser.getUnreadMessages()))
